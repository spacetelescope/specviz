...
DESCRIPTION = metadata.get('description', 'An interactive astronomical 1D spectra analysis tool')
...
if sys.version_info < tuple((int(val) for val in __minimum_python_version__.split('.'))):
    sys.stderr.write("ERROR: specviz requires Python {} or later\n".format(__minimum_python_version__))
    sys.exit(1)
...
entry_points['glue.plugins'] = ['specviz=specviz.third_party.glue:setup']
