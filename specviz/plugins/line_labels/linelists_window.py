...
class LineListsWindow(ClosableMainWindow):
    ...
    def __init__(self, hub, parent=None):
        ...
        self.erase_button.clicked.connect(lambda:self.plot_window.plot_widget.erase_linelabels.emit(self.plot_window.plot_widget))
        self.dismiss_button.clicked.connect(lambda:self.plot_window.plot_widgetdismiss_linelists_window.emit(False))
